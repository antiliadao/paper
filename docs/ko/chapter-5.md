...
둘째, 마지막 36명의 AS 엘리트들이 선구자 상을 받게 됩니다. 이는 그들의 용기에 대한 인정입니다.

마지막으로, 90%의 자금이 새로운 둥지 건설상으로, 새 사이클의 우수한 건설자들에게 4차례에 걸쳐 지급됩니다.
...
전통적인 비즈니스 세계에서는 위기가 오면 강자가 도망가고 약자가 손실을 떠안는 경우가 많다. 하지만 개미 홈에서는 위기가 새로운 기회의 시작이 되었다. 마지막까지 참여를 고수한 AS 엘리트들은 풍부한 선구자 상을 획득했고, 모든 참여자의 관계 네트워크가 완전히 보존되어 새 사이클 발전의 견고한 기반을 마련했다.
...
새로운 둥지 건설상의 거대한 매력으로 인해 수많은 우수한 건설자들이 몰려들었다. 이들 중에는 기존 사용자와 개미 홈의 "불사조 열반" 이야기에 매료된 새 사용자 모두가 포함되어 있었다. 그들은 새로운 자금, 새로운 아이디어, 새로운 활력을 가져왔다.
...
- 새 둥지 건설상: 90% 자금을 새 사이클 발전에 투입

- 선구자 보상: 10%로 고수자에게 보상, 충성심 격려
...
3. **인센티브 최대화**: 90% 비율로 새 사이클에 충분한 발전 동력 확보
...
- 60% 리스크를 미래 수익으로 전환(90% 건설상)

- 30% 리스크를 시스템이 부담(준비금 잉여)
...
contract MigrationDetector {
 ...
 uint256 pioneerReward = remainingFunds * 10 / 100; // 10% 선구자상
 uint256 buildingReward = remainingFunds * 90 / 100; // 90% 건설상
